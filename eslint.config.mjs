...
const CUSTOM_CONFIG = {
	...
	"BASE_RULES": {
		...
		"array-element-newline": [ "off", "error", { "multiline": false, "minItems": 1 } ],
		"array-bracket-newline": [ "off", "error", { "multiline": false, "minItems": 1 } ],
		...
		"capitalized-comments": [ "off", "always", { "ignorePattern": "eslint|istanbul|ts-ignore|prettier-ignore", "ignoreInlineComments": true, "ignoreConsecutiveComments": true } ],
		"class-methods-use-this": [ "off", { "exceptMethods": [], "enforceForClassFields": false } ],
		...
		"id-length": [ "off", { "min": 2, "max": 40, "exceptions": [ "i", "j", "k", "x", "y", "_" ] } ],
		"id-match": [ "off", "^[_$a-zA-Z][_$a-zA-Z0-9]*$", { "properties": false, "onlyDeclarations": false, "ignoreDestructuring": false } ],
		"implicit-arrow-linebreak": [ "error", "beside" ],
		"indent": [ "error", "tab", { "SwitchCase": 1, "flatTernaryExpressions": false, "ignoredNodes": [], "offsetTernaryExpressions": true } ],
		...
		"lines-around-comment": [ "off", { "beforeBlockComment": true, "afterBlockComment": false, "beforeLineComment": false, "afterLineComment": false, "allowBlockStart": true, "allowBlockEnd": true, "allowClassStart": true, "allowClassEnd": true, "allowObjectStart": true, "allowObjectEnd": true, "allowArrayStart": true, "allowArrayEnd": true } ],
		"lines-between-class-members": [ "error", "always", { "exceptAfterSingleLine": true } ],
		"logical-assignment-operators": [ "error", "always", { "enforceForIfStatements": true } ],
		"max-len": [ "warn", { "code": 500, "tabWidth": 2, "ignoreUrls": true, "ignoreComments": false, "ignoreTrailingComments": false, "ignoreStrings": true, "ignoreTemplateLiterals": true, "ignoreRegExpLiterals": true } ],
		"max-depth": [ "warn", 4 ],
		"max-lines": [ "off", { "max": 1000, "skipBlankLines": true, "skipComments": true } ],
		"max-lines-per-function": [ "off", { "max": 150, "skipBlankLines": true, "skipComments": true, "IIFEs": true } ],
		"max-params": [ "off", { "max": 4 } ],
		"max-nested-callbacks": [ "off", { "max": 3 } ],
		"max-statements": [ "off", { "max": 40 } ],
		...
		"no-unused-vars": [ "warn", { "vars": "all", "args": "after-used", "caughtErrors": "none", "ignoreRestSiblings": true, "varsIgnorePattern": "^_", "argsIgnorePattern": "^_" } ],
		"no-var": [ "error" ],
		"no-implicit-coercion": [ "error", { "boolean": true, "number": true, "string": true, "allow": [] } ],
		"no-magic-numbers": [ "off", { "ignore": [ -1, 0, 1, 2 ], "ignoreArrayIndexes": true, "enforceConst": true, "detectObjects": false } ],
		...
		"no-extra-parens": [ "off", "all", { "conditionalAssign": true, "returnAssign": false, "nestedBinaryExpressions": false, "enforceForArrowConditionals": false } ],
		"no-extra-semi": [ "error" ],
		...
		"semi": [ "error", "always" ],
		"sort-imports": [ "off", { "ignoreCase": false, "ignoreDeclarationSort": false, "ignoreMemberSort": false, "allowSeparatedGroups": true } ],
